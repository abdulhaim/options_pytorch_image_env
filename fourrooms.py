...
"""
        ...
        self.state_space = spaces.Box(low=0., high=1., shape=(np.sum(self.occupancy == 0),))
        ...
        self.init_states = list(range(self.state_space.shape[0]))
    ...
    def render(self, show_goal=True):
        ...
        return self.process_image(current_grid)

    def process_image(self, img):
        img_process = imresize(img, (84, 84), interp='nearest', mode=None)   
        img_process = img_process / 255.0
        return img_process     
    ...
    def step(self, action):
        ...
        return self.render(show_goal=True), reward, done, None
